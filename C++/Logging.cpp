...
template class Logger<LOG::Concurrency>;
template class Logger<LOG::States>;
template class Logger<LOG::Events>;
template class Logger<LOG::Connections>;
template class Logger<LOG::Singletons>;
